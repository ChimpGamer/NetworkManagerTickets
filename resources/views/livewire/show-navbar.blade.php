            ...
            <ul class="flex flex-col gap-2 my-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                ...
                <li class="block p-1 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button class="flex items-center transition-colors hover:text-blue-500" type="submit">Logout</button>
                    </form>
                    {{--<a href="/logout" class="flex items-center transition-colors hover:text-blue-500">
                        Log out
                    </a>--}}
                </li>
            </ul>
